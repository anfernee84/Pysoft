...
from queries import DBAddressBook, DBNotes
    ...
    while True:
        try:
            ...
            if sep_command[0] == "add" and sep_command[1] == "contact":
                address_book.add_record(sep_command[2].title(),
                                               sep_command[3],
                ...
                try:
                    DBNotes.note_insert(sep_command[2], sep_command[3], sep_command[4])
                except Exception as error:
                    print (f"Note hasn`t added {error}")
                ...
                try:
                    DBAddressBook.all_user()
            
                except Exception as error:
                    print (f"There`s no records {error}")
                ...
                address_book.edit_contact(sep_command[2], sep_command[3], sep_command[4], sep_command[5], sep_command[6], sep_command[7])
                ...
                try:
                    DBNotes.note_delete(sep_command[2])
                except Exception as error:
                    print (f"Note hasn`t found {error}")
